...
export const resumeConfig: ResumeConfig = {
  ...
  seo: {
    title: "MAIZY Amaury — Fullstack Developer",
    description:
      "Interactive resume of MAIZY Amaury, Fullstack Developer specializing in React and TypeScript.",
  },
  ...
  contact: [
    {
      type: "github",
      label: "ExostFlash",
      href: "https://github.com/ExostFlash",
    },
    {
      type: "linkedin",
      label: "MAIZY Amaury",
      href: "https://linkedin.com/in/amaury-maizy",
    },
    {
      type: "email",
      label: "amaury@maizy.net",
      href: "mailto:amaury@maizy.net",
    },
    { type: "phone", label: "+33 6 67 ?? ?? 65" },
  ...
  skills: [
    ...
    },
    {
      ...
      type: "badges",
      items: [{ name: "React" }, { name: "TypeScript" }, { name: "Angular" }],
    },
    {
      title: { en: "Backend", fr: "Backend" },
      type: "badges",
      items: [{ name: "Node.js" }, { name: "Python" }],
    },
    {
      title: { en: "Database", fr: "Base de données" },
      type: "badges",
      items: [{ name: "PostgreSQL" }, { name: "MongoDB" }],
    },
    {
